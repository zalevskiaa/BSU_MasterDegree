...
void TestBfsOrder() {
     ...
     *     ^-----------'
     */
    std::vector<std::pair<test_bfs::BfsEvent, int>> events;
    test_bfs::TestBfsVisitor visitor(&events);
    traverses::BreadthFirstSearch(a, graph, visitor);

    std::vector<std::pair<test_bfs::BfsEvent, int>> expected{
            {test_bfs::BfsEvent::kDiscoverVertex, a},
            {test_bfs::BfsEvent::kExamineVertex,  a},
            {test_bfs::BfsEvent::kExamineEdge,    b},
            {test_bfs::BfsEvent::kDiscoverVertex, b},
            {test_bfs::BfsEvent::kExamineEdge,    c},
            {test_bfs::BfsEvent::kDiscoverVertex, c},
            {test_bfs::BfsEvent::kExamineVertex,  b},
            {test_bfs::BfsEvent::kExamineEdge,    d},
            {test_bfs::BfsEvent::kDiscoverVertex, d},
            {test_bfs::BfsEvent::kExamineVertex,  c},
            {test_bfs::BfsEvent::kExamineEdge,    d},
            {test_bfs::BfsEvent::kExamineVertex,  d},
            {test_bfs::BfsEvent::kExamineEdge,    a}
    };
